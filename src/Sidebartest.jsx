      ...
      <div className="sticky top-0 w-64 left-0">
        ...
        <ul className="sidebar-nav flex-grow">
          ...
          <li className="sidebar-item list-item">
            ...
            <ul className="sidebar-dropdown pl-0 list-none">
          ...
          <li className="sidebar-item active">
            <a href="" className="sidebar-link list-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layout align-middle inline-block"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg> <span class="align-middle">Pages</span>
            </a>
            <ul id="pages" className="sidebar-dropdown pl-0 list-none">
